...
public class DemoQA {
    public static void main(String[] args) {
        ...
        try {
            ...
            stateDropdown.click();
            WebElement stateOption = driver.findElement(By.xpath("//div[contains(text(),'Haryana')]"));
            stateOption.click();
            Thread.sleep(2000);
            ...
            cityDropdown.click();
            WebElement cityOption = driver.findElement(By.xpath("//div[contains(text(),'Panipat')]"));
            cityOption.click();
            Thread.sleep(2000);
